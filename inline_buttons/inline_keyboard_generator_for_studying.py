# Добавил этот файл, для лучшего запоминания функции, которая генерирует инлайн клавиатуру
...
def create_inline_kb(width: int, *args: str, last_btn: str | None = None, **kwargs: str) -> InlineKeyboardMarkup:
    ...
    # Распаковываем список с кнопками в билдер методом row c парам-ом width
...
# Этот хэндлер будет срабатывать на команду старт и отправлять в чат клавиатуру
